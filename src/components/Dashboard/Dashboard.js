    ...
    return <div className="web">
        ...
        <section className="how_we_work">
            ...
            <div className="how_we_work__item">
                <div className="stroke">
                    ...
                    <p className="form_name">
                        In your account you can monitor the progress of work, the amount of working time, the cost of
                        work,
        ...
        <section className="helper">
            ...
            <p className="helper_content">
                We help businesses, startups, and just people to order and get a unique, high-quality design easily and
                quickly
            </p>
            <Link to="/login" className="btn_started">
                <span>Get started</span>
